...
public class CreateChangeLogCommandTests
{
    ...
    private CreateChangeLogCommand Subject { get; set; } = default!;
    ...
    public void TestInitialize()
    {
        ...
        Subject = new(MockFileSystemService.Object, GitService, RepositoryService);
    }
    ...
    public async Task ExecuteAsync_Should_Work()
    {
        ...
        CreateChangeLogCommand.Settings settings = new();
